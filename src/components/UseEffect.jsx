        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          {countries.map((country) => (
            <div
              ...
              className={`bg-white rounded-lg shadow-md overflow-hidden cursor-pointer transition-transform transform hover:scale-105 ${filteredCountry && filteredCountry.cca3 === country.cca3 ? 'ring-2 ring-blue-500' : ''
                }`}
